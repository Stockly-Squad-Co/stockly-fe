...
const SingleProductPage = () => {
  ...
  return (
    <section className="p-4 md:p-6">
      ...
      <div className="p-4 md:p-8 rounded-md grid grid-cols-4 border shadow-md">
        <article>
      ...
      <div className="flex gap-4 mt-5">
        ...
        <div className="rounded-md shadow-md bg-white border flex-[2]">
      ...
      <div className="rounded-md shadow-md bg-white border mt-6">
        <h2 className="font-semibold text-[1.1rem] bg-gray-50 p-2 text-gray-700">
          Product History
        </h2>
