...
export const navLinks = [
  ...
  { title: "Pricing", sublinks: ["Free", "Business", "Enterprise"] },
  {
    title: "Resources",
...
export const faqCategories: FAQCategories = {
  General: [
    {
      ...
      answer:
        "Stockly is a store management system for inventory, sales, and financial tracking.",
    },
    {
      question: "Is there a mobile version of Stockly?",
      answer:
        "Yes, Stockly is fully responsive and works seamlessly on all devices.",
    },
    {
      question: "Who can use Stockly?",
      answer:
        "Stockly is designed for small businesses, retail shops, and e-commerce platforms.",
    },
    {
      question: "Do I need technical knowledge to use Stockly?",
      answer:
        "No, Stockly is user-friendly and requires no coding skills to manage your store.",
    },
    {
  ...
  Payments: [
    {
      ...
      answer:
        "Businesses receive funds directly into their virtual bank accounts.",
    },
    {
      question: "Can I integrate my own payment gateway?",
      answer:
        "Yes, we support custom integrations with various payment providers.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, Stockly supports multiple currencies and international transactions.",
    },
    {
      question: "How long does it take for funds to reflect in my account?",
      answer:
        "Funds are processed instantly or within 24 hours, depending on the payment provider.",
    },
    {
  ...
  Features: [
    {
      ...
      answer:
        "Yes, businesses can generate QR codes and payment links for transactions.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, you can set up automated expense tracking and periodic payments.",
    },
    {
      question: "Can I analyze sales trends?",
      answer:
        "Absolutely! Stockly provides sales analytics and financial insights.",
    },
    {
  ...
  Support: [
    ...
    },
    {
      ...
      answer:
        "You can reset your password from the login page or contact support.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yes, Stockly uses industry-standard encryption to keep your data safe.",
    },
  ],
};
...
export const features = [
  {
    ...
    description:
      "Track stock levels, receive restock alerts, and manage your products effortlessly.",
  ...
  },
  {
    ...
    description:
      "Accept online payments securely and manage transactions with virtual bank accounts.",
  ...
  },
  {
    ...
    description:
      "Get real-time analytics on sales, revenue trends, and customer behavior.",
...
export const pricingPlans = [
  ...
  },
  {
    ...
    price: "N7,500",
    description:
      "Ideal for small and growing businesses that need more control.",
    features: [
